...
\begin{document}
	\author{Wiskundeplan}
	\xmtitle{Rationale vormen: uitgewerkte voorbeelden}{}

Rationale vormen of gebroken lettervormen zijn ``breuken met letters''. Met de rekenregels voor breuken en het ontbinden in factoren kunnen deze uitdrukkingen vereenvoudigd worden. 
...
\begin{enumerate}
 ...
 \end{enumerate}
    ...
    \begin{question} \( \frac{a^2 b}{5ab^3}                                     =\answer[onlineshowanswerbutton]{ \frac{a}{5b^2}                                                   } \) \end{question}
    \begin{question} \( \frac{a - b}{a^2 - b^2}                                 =\answer[onlineshowanswerbutton]{\frac{a - b}{(a - b)(a + b)} = \frac{1}{a + b}                    } \) \end{question}
    \begin{question} \( \frac{-x^3 + x^2 + 2x - 2}{x^2 - 1}                     =\answer[onlineshowanswerbutton]{ \frac{(x - 1)(-x^2 + 2)}{(x - 1)(x + 1)} = \frac{-x^2 + 2}{x + 1}} \) \end{question}   
\end{example}
