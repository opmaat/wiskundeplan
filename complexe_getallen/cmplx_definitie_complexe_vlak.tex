...
\begin{exercise} Teken devolgende complexe getallen als punten van het complexe vlak. 

	\renewcommand{\xmFixFormatLength}{1cm}
	\renewcommand{\xmFixFormatPosition}{l}
